<script type="text/javascript">
  ...
  $(".content-header small").html("<?php echo $event_details['department'] ?>");
</script>
  ...
  <div class="row">
    <div class="col-md-12">
      ...
      <div class="form-group pull-right">
        <a href="<?php echo base_url('institution_calendar') ?>" class="btn btn-primary flat"><i class="fa fa-arrow-left"></i> Back to calendar</a>
      </div>
    </div>
  </div>
