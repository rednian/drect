		...
		<form id="form_create_calendar" method="post">
			<div class="col-md-9">
				<div class="form-group">
					...
					<!-- <a href="<?php echo base_url('/institution_calendar') ?>" class="btn btn-danger flat"><i class="fa fa-times"></i> Cancel</a> -->
  ...
  var txtdescription;
	$(function(){
      ...
      $('#form_create_calendar').bootstrapValidator({
          ...
          fields: {
            calendar_name: {
              ...
              validators: {
                ...
                remote: {
                  url: '<?php echo base_url("/institution_calendar/check_calendar_name") ?>',
          ...
          $.ajax({
              url: "<?php echo base_url('/institution_calendar/insert_calendar') ?>",
              type: "POST",            
