	...
	<div class="row">
		<div class="col-md-3">
			<div class="form-group">
				<a style="width:100%" href="<?php echo base_url('personal_calendar/create_calendar') ?>" class="btn btn-primary flat"><i class="fa fa-calendar"></i><sup><i class="fa fa-plus"></i></sup> Create New Calendar</a>
			</div>
...
load_calendars();
  ...
  function load_calendars(){
    var display = "";
    $.ajax({
      url: "<?php echo base_url('personal_calendar/load_calendars') ?>",
      dataType: "json",
      ...
      $(function () {
        ...
        $('#calendar').fullCalendar({
          ...
          events: "<?php echo base_url('personal_calendar/load_events_in_calendar') ?>",
          ...
          dayClick: function(date, jsEvent, view) {
            ...
            location.href="<?php echo base_url('personal_calendar/create_event').'/'?>"+Base64.encode(selectedDate);
          }
    ...
    function create_event(calendar_id){
      location.href="<?php echo base_url('personal_calendar/create_event').'/'?>"+Base64.encode(calendar_id);
    }
    function view_event(event_id){
      location.href="<?php echo base_url('personal_calendar/view_event').'/'?>"+Base64.encode(event_id);
    }
    ...
    function get_events(){
      $.ajax({
        url: "<?php echo base_url('personal_calendar/get_events') ?>",
    ...
    function delete_calendar(){
      $.ajax({
        url: "<?php echo base_url('personal_calendar/delete_calendar') ?>",
        data: {calendar_id : content_menu_selected_id},
        type: "GET",
        dataType: "json",
        success: function(data){
    ...
    function change_calendar(calendar_id, calendar_name){
      ...
      $('#calendar').fullCalendar('removeEventSource',"<?php echo base_url('personal_calendar/load_events_in_calendar') ?>"); 
      $('#calendar').fullCalendar('removeEventSource',"<?php echo base_url('personal_calendar/load_events_in_calendar').'/' ?>"+prev_cal);
      $('#calendar').fullCalendar('addEventSource',"<?php echo base_url('personal_calendar/load_events_in_calendar').'/' ?>"+calendar_id); 
    ...
    function view_all_calendar(){
      ...
      $('#calendar').fullCalendar('removeEventSource',"<?php echo base_url('personal_calendar/load_events_in_calendar') ?>"); 
      $('#calendar').fullCalendar('removeEventSource',"<?php echo base_url('personal_calendar/load_events_in_calendar').'/' ?>"+prev_cal);
      $('#calendar').fullCalendar('addEventSource',"<?php echo base_url('personal_calendar/load_events_in_calendar') ?>");
    }
    ...
    function search_event(key){
      if(key.length == 0 || key.trim() == ""){
        ...
        $.ajax({
          url: "<?php echo base_url('personal_calendar/search_event') ?>",
          data: {search : key},
          type: "GET",
          dataType: "html",
          success: function(data){
