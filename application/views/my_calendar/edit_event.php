...
<section class="content">
	<div class="row">
		<form id="form_create_event" method="post" action="<?php echo base_url('personal_calendar/is_overlapped') ?>">
			<div class="col-md-9">
...
<script type="text/javascript">
		...
		$("#calendar_id").val(<?php echo $event_details['calendar_id']; ?>);
	...
	$(function(){
  	...
  	$(document).ready(function(){
  		$("#form_create_event").on("submit",function(e){
  			e.preventDefault();
  			$.ajax({
              url: "<?php echo base_url('personal_calendar/is_overlapped') ?>",
              type: "POST",            
		...
		$("#modal-btn-save-event").on("click",function(e){
			...
			$.ajax({
				url: "<?php echo base_url('personal_calendar/insert_event') ?>",
