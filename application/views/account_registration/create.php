    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="row">
                ...
                <form id="form-account-registration" method="POST" action="<?php echo base_url('user_account/insert')?>">

                     <div class="col-lg-12" style="padding-bottom:10px">
                         <a href="<?php echo base_url('user_account'); ?>" class="btn btn-default flat pull-right"><i class="fa fa-table"></i> Back to List</a>
                        <button class="btn btn-success flat" id="btn-submit" type="submit">SAVE</button>
                        <button onclick="reset_form()" id="btn-reset" class="btn btn-danger flat" type="reset">CANCEL</button>
                    </div>
                          ...
                          <div class="box-body">
                              ...
                              <div class="row">
                                  <div class="col-lg-8">
                                      ...
                                      <div class="form-group">
                                          <input placeholder="Middle Name" type="text" class="form-control"
                                      ...
                                      <div class="form-group">
                                          ...
                                          <div class="form-group">
                                              <div class="input-group">
                                                  ...
                                                  <input required name="birthdate" id="birthdate" type="text"
                                      ...
                                      <div class="form-group">
                                          ...
                                          <div class="form-group">
                                              <div class="input-group">
                                                  ...
                                                  <input name="contact_no" type="text" class="form-control" data-inputmask='"mask": "+639999999999"' data-mask>
                                              </div><!-- /.input group -->
                                          </div>
                                      </div>
                                              ...
                                              <select name="pos_id" id="pos_id" class="form-control">
                                                  ...
                                                  <?php 
                                                    foreach($positions as $pos){
                                                      echo "<option pos_type='{$pos->position_type}' value='{$pos->pos_id}'>{$pos->position}</option>";
                                                    }
                                                  ?>
                                              </select>
                                          </div>
                                      ...
                                      <div class="form-group">
                                          ...
                                          <div class="form-group">
                                              <div class="input-group">
                                                  ...
                                                  <input placeholder="Username" required name="username" id="username"
...
$(document).ready(function(){
      ...
      $('#form-account-registration').bootstrapValidator({
          ...
          $.ajax({
              url: "<?php echo base_url('user_account/insert') ?>",
              type: "POST",            
...
$(document).ready(function(){
  $("select[name=pos_id]").on("change", function(){
    var pos_type = $('option:selected', this).attr('pos_type');
    $("input[type=checkbox][class=option]").prop("checked", false);
    $.ajax({
      url: "<?php echo base_url('user_account/get_access_per_pos') ?>",
      data: {pos_type : pos_type},
      type: "GET",
      dataType: "json",
      success: function(data){
        $.each(data, function( key, value){
          $("input[type=checkbox][class=option][value="+value['am_id']+"]").prop("checked", true);
        });
      },
      error: function(){
