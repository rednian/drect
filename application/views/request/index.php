...
<section class="content">
	...
	<div class="row">
		<div class="col-lg-12">
			...
			<div>
				<a id="sample_right" href="<?php echo base_url("request/create") ?>" class="btn btn-primary pull-right flat"><i class="fa fa-edit"></i> Create Request</a>
			  <!-- Nav tabs -->
          ...
          <!-- <li role="presentation" id="tab_receive"><a href="#receive" aria-controls="receive" role="tab" data-toggle="tab"> <i class="fa fa-edit"></i> Receive Request <span style="background:rgb(99, 169, 210);visibility:hidden" class="badge">0</span></a></li> -->
            ...
            <div class="row">
              <div class="col-md-7">
                <div class="form-group">
                  <form id="form_receive_request" method="post" action="<?php echo base_url('request/receive_request_task') ?>">
                ...
                <div id="remarks_container" class="div_hide">
                  ...
                  <form method="post" id="form_process_decline">
                    <div class="form-group">
...
<div class="list-group" id="contextMenu" style="display:none;z-index:1000;width:150px">
  <a href="#" onclick="confirm_cancel()" class="list-group-item"><i class="fa fa-times"></i> Cancel Request</a>
...
<script type="text/javascript">
  ...
  $(function(){
    ...
    function load_initial_request(){
        $.ajax({
            url: "<?php echo base_url('request/load_list_initial') ?>",
            dataType: "JSON",
    ...
    function update_list(){
        ...
        $.ajax({
            url: "<?php echo base_url('request/load_list_processing') ?>",
            dataType: "JSON",
            success: function(data){
    ...
    function view(id){
        location.href = "<?php echo base_url('request/view') ?>/"+id;
    }
    ...
    function show_remarks(rt_id){
      ...
      $.ajax({
        url: "<?php echo base_url('request/get_remarks') ?>",
        data: {rt_id : rt_id},
        type: "GET",
        dataType: "json",
        success: function(data){
    ...
    $(document).ready(function(){
      ...
      $("#form_receive_request").on("submit", function(e){
        e.preventDefault();
        $.ajax({
          url: "<?php echo base_url('request/sample') ?>",
          type: "POST",            
    ...
    function get_process(rt_id){
        $.ajax({
          url: "<?php echo base_url('request/get_request_process') ?>",
          data: {rt_id : rt_id},
          dataType: "html",
          success: function(data){
...
function update_process_overdue(rt_id){
  $.ajax({
    url: "<?php echo base_url('request/update_overdue') ?>",
    data: {rt_id : rt_id},
    type: "GET",
    dataType: "json",
    success: function(data){
...
$(document).ready(function(){
  ...
  $("form#form_process_decline").on("submit", function(e){
      ...
      $.ajax({
        url: "<?php echo base_url('request/process_denied') ?>",
