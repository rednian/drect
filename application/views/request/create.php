<section class="content">
	<div class="row">
		...
		<div class="col-lg-12">
			...
			<form method="post" id="form_submit_request" enctype="multipart/form-data" action="<?php echo base_url("request/insert_request") ?>">

			<div class="form-group">
				<button type="submit" class="btn btn-success flat"><i class="fa fa-save"></i> Send Request</button>
				<button type="reset" class="btn btn-danger flat"><i class="fa fa-times"></i> Cancel</button>
				<a href="<?php echo base_url('request') ?>" class="btn btn-primary flat pull-right"><i class="fa fa-table"></i> Back to list</a>
			</div>
...
<script type="text/javascript">
	...
	function get_form(procedure_id){
		$.ajax({
			url: "<?php echo base_url('request/get_form_procedure') ?>",
	...
	$(document).ready(function(){
		...
		$("#form_submit_request").on("submit", function(e){
			...
			$.ajax({
              url: "<?php echo base_url('request/insert_request') ?>",
              type: "POST",            
